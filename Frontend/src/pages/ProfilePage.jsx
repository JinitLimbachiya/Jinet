...
const ProfilePage = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    reader.onload = async () => {
      ...
      await updateProfile({ profilePicture: image })
    }
  }
      ...
      className='max-w-2xl mx-auto p-4 py-8'>
        ...
        className='bg-base-300 rounded-xl p-6 space-y-8'>
          ...
          className='text-center'>
            ...
            <p
            className='Your profile information'>
            </p>
          </div>
          ...
          className='flex flex-col items-center gap-4'>
            ...
            className='relative'>
              <img
              src={selectedImg || authUser.profilePicture || "/DefaultAvatar.png"}
              alt="Profile"
            ...
            className='text-sm text-zinc-400'>
              { isUpdatingProfile ? "Uploading..." : "Click the camera icon to upload photo" }
            </p>
